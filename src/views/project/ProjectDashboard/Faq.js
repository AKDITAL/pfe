        ...
        <div className="grid grid-flow-row auto-rows-max gap-4 ">
            <div className="bg-white rounded">
              <p className="bg-blue-100 text-center text-xl ">Est-on obligé(e) d’aller en rééducation en post opératoire ?</p>
                ...
                cardiovasculaire et permettent un suivi étroit pendant la période post opératoire. Ils vous
                accompagneront dans la reprise progressive de vos activités physiques. Des modules d’éducation
                thérapeutique vous seront également proposés pour vous permettre de comprendre et de limiter les effets
                négatifs des facteurs de risque cardiovasculaire. Tout cela est indispensable pour une prise en charge
                globale de qualité sur le long terme.
            </div>
            <div className="bg-white rounded">
                ...
                cours de votre hospitalisation, après votre sortie de réanimation, et choisiront avec vous le centre le
                plus adapté en fonction de votre lieu de domicile, de vos besoins et des places disponibles.

                Les équipes soignantes sont à votre disposition tout au long de votre hospitalisation pour discuter avec
                vous de l’organisation à mettre en place à votre sortie de l’hôpital. N’hésitez pas à interroger votre
                chirurgien.
            </div>
            <div className="bg-white rounded">
            ...
            <div className="bg-white rounded">
                ...
                Toutes les organisations sont envisageables et pourront être mises en place « sur mesure » en fonction
                de votre état de santé, des éventuelles aides disponibles à votre domicile, du délai d’attente pour
                obtenir une place dans le centre de rééducation de votre choix. Le plus important est que vous
                réfléchissiez rapidement à différentes possibilités et que nous puissions organiser votre sortie de
                l’hôpital avec vous dès votre sortie de réanimation. Pour vous aider dans vos réflexions, votre
            ...
            <div className="bg-white rounded">
                ...
                rentrerez à l’hôpital l’avant veille de votre intervention de façon à ce que nous ayons le temps
                nécessaire à votre préparation et que vous puissiez à nouveau rencontrer un médecin anesthésiste
                réanimateur et votre/vos chirurgien(s). La durée habituelle de votre séjour en réanimation post
                opératoire est de 24 à 72h. La durée habituelle de votre séjour à l’hôpital (réanimation incluse) après
                la chirurgie est d’environ une semaine. Ces durées sont bien entendu indicatives, dépendant de votre
                récupération, de l’introduction de traitements longs à équilibrer ou de la survenue éventuelle de
