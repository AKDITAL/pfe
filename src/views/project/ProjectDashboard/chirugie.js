    ...
    <div><div className="bg-white rounded ">
        ...
        <div className="flex">
            ...
            <div className="w-93">
                ...
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">Akdital Tanger | Hôpital Privé de Tanger</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">Av. Moulay Rachid, Tanger 90050</p>
                    </div>
                </div>
                <div className="h-2"></div>
                <div className="flex">
                ...
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">En voiture personnelle;</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">- Parking P4, avenue Jean Poulhès, sur la droite puis accès au site par ascenseur</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">- Parkings P1 et P2, dédiés aux patients venant en consultation</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">- « Dépose-minute » devant le hall d’accueil puis parkings P1 ou P2</p>
                    </div>
                </div>
                <div className="h-2"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">En ambulance ou véhicule sanitaire (VSL) :</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">Accès par la route de Narbonne, prendre la 1ère entrée à gauche après le pont du périphérique (avant le giratoire)</p>
                    </div>
                </div>
                <div className="h-2"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">En métro et bus :</p>
                    </div>
                </div>
                <div className="h-1"></div>
                <div className="flex">
                    <div className="w-full">
                        <p className="text-justify">- Métro ligne B, arrêt "Faculté de Pharmacie" puis bus n° 37 (arrêt Rangueil-Maternité)</p>
                    </div>
                </div>
            </div>
        </div>
